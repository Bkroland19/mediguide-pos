...
- Consultants were migrated to typed routes and later removed from the
  product entirely. Migration `00062_drop_consultants.sql` drops the
...
| Consultants — removed | Former compatibility resources: `consultants`, `consultant_usage_logs` | No client surface; the directory was removed from the dashboard and the Flutter app. | None. | None; migration `00062_drop_consultants.sql` drops both tables. | Not applicable. |
