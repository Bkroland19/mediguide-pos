...
class EditProfileDialog extends StatelessWidget {
                  ...
                  : Text(
                      ...
                      style: TextStyle(
                        ...
                        color: controller.hasChanges.value
                          ...
                          : context.theme.colorScheme.onSurface.withValues(alpha: 0.4),
                      ),
                    ),
              )),
            ],
            ...
            builder: (controller) {
              ...
              return FormBuilder(
                ...
                onChanged: () {
                  ...
                  final formValues = controller.formKey.currentState?.instantValue;
                  if (formValues == null) return;

                  final hasFormChanges = formValues['name'] != user.name ||
              ...
              children: [
                ...
                FormBuilderTextField(
                  ...
                  validator: FormBuilderValidators.compose([
                    FormBuilderValidators.match(
                      RegExp(r'^[+]?[0-9\s\-\(\)]{7,20}$'),
                      errorText: AppTranslationKey.invalidAlternativePhoneFormat.tr,
                    ),
                  ]),
                ),
  ...
  Future<void> _pickAndUploadAvatar(EditProfileController controller) async {
    print('_pickAndUploadAvatar called'); // Debug: Check if function is called
    try {
      print('About to call FilePicker.platform.pickFiles'); // Debug
      
      final result = await FilePicker.platform.pickFiles();

      print('FilePicker result: $result'); // Debug: Check picker result
