...
/// Abbreviation model based on backend abbreviations collection
class Abbreviation extends BaseModel {
  ...
  /// Create Abbreviation from backend record
  ...
  String get categoryName =>
      category?.displayName ?? get<String>("category", "");
  ...
  List<String> get tagNames {
    if (tags.isNotEmpty) {
      return tags.map((tag) => tag.displayName).toList();
    }
    return get<List<String>>("tags", <String>[]);
  }
