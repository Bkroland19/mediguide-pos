...
abstract class BaseModel extends RecordModel {
  ...
  static String get collection => throw UnimplementedError('Each model must implement static String get collection');
  
  // Model registry for dynamic model creation
  static final Map<String, BaseModel Function(Map<String, dynamic>)> _modelRegistry = {};
  
  /// Register a model factory for a collection
  static void registerModel(String collectionName, BaseModel Function(Map<String, dynamic>) factory) {
    _modelRegistry[collectionName] = factory;
  }
  
  /// Create a model instance dynamically from collection name (replaces switch statements)
  static T? createModelFromRegistry<T extends BaseModel>(Map<String, dynamic> data) {
