...
/// Base model extending backend's RecordModel with common functionality
abstract class BaseModel extends RecordModel {
  BaseModel(super.data);

  /// Each model must define its backend collection name
  ...
  T? getRelation<T extends BaseModel>(String fieldName) {
    try {
      ...
      // Handle both single objects and arrays (backend can return both)
