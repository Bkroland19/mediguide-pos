...
class AbbreviationUsageLog extends BaseModel {
  ...
  static AbbreviationUsageLog fromRecord(RecordModel record) => AbbreviationUsageLog(record.data);
  ...
  late final Abbreviation? abbreviation = getRelation<Abbreviation>("abbreviation_id");
