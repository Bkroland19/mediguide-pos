...
class HealthFacility extends BaseModel {
  ...
  static HealthFacility fromRecord(RecordModel record) => HealthFacility(record.data);
  ...
  late final FacilityLevel? facilityLevel = getRelation<FacilityLevel>("facility_level");
  ...
  late final HealthSubDistrict? healthSubDistrict = getRelation<HealthSubDistrict>("health_sub_district");
  ...
  late final HealthSubRegion? healthSubRegion = getRelation<HealthSubRegion>("health_sub_region");
