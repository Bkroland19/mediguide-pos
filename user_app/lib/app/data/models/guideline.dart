...
/// Medical guideline model based on backend medical_guidelines collection
class Guideline extends BaseModel {
  ...
  /// Create Guideline from backend record
  ...
  String get indexItemTitle =>
      indexItem?.title ?? get<String>("index_item_title", "");
