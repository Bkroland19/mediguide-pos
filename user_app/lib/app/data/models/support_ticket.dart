...
class SupportTicket extends BaseModel {
  ...
  // Status and priority
  late final TicketStatus status = getEnum<TicketStatus>("status", TicketStatus.values) ?? TicketStatus.open;
  late final TicketPriority priority = getEnum<TicketPriority>("priority", TicketPriority.values) ?? TicketPriority.normal;
