...
class CalculatorUsageLog extends BaseModel {
  ...
  static CalculatorUsageLog fromRecord(RecordModel record) => CalculatorUsageLog(record.data);
  ...
  static Map<String, dynamic> forSessionEnd({
  ...
  late final DateTime sessionStart = DateTime.tryParse(get<String>("session_start", "")) ?? DateTime.now();
  late final DateTime? sessionEnd = DateTime.tryParse(get<String>("session_end", ""));
  
  // Enum properties with proper conversion
  late final CalculatorType calculatorType = _parseType(get<String>("calculator_type", "")) ?? CalculatorType.calculator;
  ...
  String get sessionTimeFormatted {
    final hour = sessionStart.hour > 12 ? sessionStart.hour - 12 : sessionStart.hour == 0 ? 12 : sessionStart.hour;
