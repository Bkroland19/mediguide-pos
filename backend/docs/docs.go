...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/collections/users/logout": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/collections/{collection}/records": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Legacy collection payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.GuidelineDocumentsEnvelope"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.ClinicalProtocolsEnvelope"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        ...
        "handlers.ClinicalProtocolsEnvelope": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "handlers.GuidelineChunksEnvelope": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "handlers.GuidelineDocumentsEnvelope": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "handlers.GuidelineSectionsEnvelope": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
